    	...
    	<div class="container post format-standart">
        	<div id="navbar" class="navbar-collapse collapse">	
                <ul class="nav navbar-nav">
                    ...
                    <i class="fas fa-angle-right"></i>
                    <a href="<?=base_url() ?>article/LUBY_news">LUBY消息</a>
                    <i class="fas fa-angle-right"></i>
                    <?=$title ?></p>
                </ul>
            </div>
    			...
    			<nav class="nav-single clearfix">
                    ...
                    <?php if($article_item_prev) : ?>
                        <div class="nav-previous text-left">
        					<a href="<?=base_url() ?>article/news_detail/<?=$code?>/<?=$article_item_prev['id'] ?>">
        						<small>上一則</small>
                    ...
                    <?php if($article_item_next) : ?>
                        <div class="nav-next text-right">
        					<a href="<?=base_url() ?>article/news_detail/<?=$code?>/<?=$article_item_next['id'] ?>">
        						<small>下一則</small>
