<aside>
    ...
    <div class="widget">
        ...
        <ul class="category-list">
            <?php
				  $tag_list = get_article_tag_list_by_code_web(207);
				  
				  foreach ($tag_list as $tag_item) :
			?>
			<li><a href="<?=base_url() ?>article/topic_tag/<?=$tag_item['id'] ?>"><?=$tag_item['name'] ?></a></li>
			<?php endforeach; ?>
        </ul>
    </div>
	<!-- /.widget -->
    <form class="search-area form-group search-form" method="get" action="<?=base_url() ?>article/topic">
