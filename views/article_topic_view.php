			...
			<div class="container post format-standart">
                <div id="navbar" class="navbar-collapse collapse">	
                    <ul class="nav navbar-nav">
                        ...
                        <a href="<?=base_url() ?>article/topic">潤滑專題</a></p>
                    </ul>
                </div>
                <br>
				<?
				...
				<div class="col-sm-3" style="padding-left: 30px; padding-right: 30px;">
					<?php include('common/oil_sidebar_view.php'); ?>
				</div>
							  ...
							  <div class="col-sm-6" style="padding-left: 30px; padding-right: 30px;">
								...
								<div class="col-sm-6" style="padding-left: 30px; padding-right: 30px;">
										...
										<header class="entry-header">
											...
											?>
												<h3><a href="<?=base_url() ?>article/topic_detail/<?=$code?>/<?=$item['id'] ?>"><?=$item['title'] ?></a></h3>
										   <div class="meta">
										...
										<div class="entry-content">
											<p><?=$item['summary'] ?></p>
											<a href="<?=base_url() ?>article/topic_detail/<?=$code?>/<?=$item['id'] ?>" class="btn btn-primary">更多內容</a>
										</div>
								</div>
						</div>
