            ...
            <div class="box-content">
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused width-30" name="txt_name" type="text" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused width-05" name="txt_price_original" type="text" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused width-05" name="txt_price_special" type="text" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                            庫存</label>
                        <div class="controls">
                            <input class="input-xlarge focused width-05" name="txt_stock" type="text" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                            內容</label>
                        <div class="controls">
                            <textarea id="ckeditor1" name="txt_content"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
