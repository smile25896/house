                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="width-14 query_sort" s1="tel">
                                    電話
                                </th>
                                <th class="width-14 query_sort" s1="email">
                                    電子郵件
                                </th>
                                <th class="width-25 query_sort" s1="address">
                                    寄送地址
                                </th>
                                <th class="query_sort" s1="product_id">
                                    商品標題
                                </th>
                                <th class="width-08 query_sort" s1="quantity">
                                    購買數量
                                </th>
                            ...
                            <?php foreach ($result as $item): ?>
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <span data-rel="popover" data-content="<?=str_replace('"', '”', $item['comment']) ?>" title="<?=$product_item['name'] ?>">
                                        <?php
                                    ...
                                    <!--td style="text-align: left">
                                        <span data-rel="popover" data-content="<?=str_replace('"', '”', $item['reply']) ?>" title="<?=$product_item['name'] ?>">
                                        <?php
