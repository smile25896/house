<?php include('common/header_view.php'); ?>
    ...
    <ul class="breadcrumb">
        ...
        <a href="<?=base_url_admin() ?>/product_group/<?=$group ?>">商品群組</a>
        <span class="divider">/</span>
        資料列表
    </ul>
                ...
                <div class="dataTables_wrapper">
                    <div class="row-fluid search-bar">
                        ...
                        <div class="span2 text-right">
                            <a href="<?=base_url_admin() ?>/product_group/choose/<?=$group ?>" class="btn btn-warning iframe"><i class="icon-plus icon-white"></i>新增</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($result as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="if (confirm('是否刪除')) { location.href = '<?=base_url_admin() ?>/product_group/del/<?=$item['gid'] ?>'}" class="btn btn-danger form-del"><i class="icon-trash icon-white"></i>刪除 </a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
