                ...
                <form class="form-horizontal" id="my_form" method="post" action="<?=current_url() ?>">
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="sel_level" class="width-10">
                                    <option value="0" <?php if($level == '0') echo "selected='selected'"; ?>><?=get_level_text(0) ?></option>
                                    <option value="1" <?php if($level == '1') echo "selected='selected'"; ?>><?=get_level_text(1) ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="input-xlarge focused" name="txt_name" type="text" value="<?=$name ?>" />
                            </div>
                        </div>
